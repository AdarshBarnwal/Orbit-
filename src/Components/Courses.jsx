...
function Courses() {
  const courses = [
    ...
    {
      title: "Dropper Batch for NEET",
      description:
        "Specialized batch for NEET droppers focusing on speed, accuracy, and exam-oriented strategy.",
    },
    {
      title: "Dropper Batch for JEE",
      description:
        "Exclusive program for JEE droppers to improve problem-solving and advanced concept mastery.",
    },
    {
